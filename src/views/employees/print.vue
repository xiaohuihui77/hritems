...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      this.formData = (await getPersonalDetail(this.userId)).data // 获取个人基本信息
    },
    async getJobDetail() {
      const userInfo = (await getUserDetailById(this.userId)).data
      const jobInfo = (await getJobDetail(this.userId)).data // 获取个人基本信息
